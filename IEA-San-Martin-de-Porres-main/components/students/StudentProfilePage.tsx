...
const StudentProfilePage: React.FC = () => {
    ...
    if (!student) {
        return <Card><p>Cargando perfil...</p></Card>;
    }

    return (
        <div>
            <h1 className="text-2xl font-bold mb-4 text-text-primary dark:text-white">Mi Perfil</h1>
            <Card>
                <div className="flex flex-col md:flex-row items-center gap-6 p-4">
                    ...
                    <div className="text-center md:text-left">
                        ...
                        <span className="mt-2 inline-block bg-primary/10 text-primary font-semibold px-3 py-1 rounded-full text-sm dark:bg-primary/20 dark:text-sky-400">{student.role}</span>
                    </div>
                </div>
